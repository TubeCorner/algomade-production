...
{/* 📱 Mobile Notice */}
<div className="md:hidden bg-yellow-500/10 border-b border-yellow-400/30 text-yellow-200 text-xs px-4 py-2 text-center">
  ⚡ For the best experience, use AlgoMade on a desktop or laptop.
</div>
        {/* Main Workspace */}
