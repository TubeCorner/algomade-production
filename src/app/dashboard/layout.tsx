...
<div className="md:hidden">
  <div className="bg-indigo-500/10 border border-indigo-400/20 text-indigo-200 text-xs sm:text-sm rounded-xl px-4 py-3 text-center">
    💻 AlgoMade works best on desktop for advanced keyword analytics and smoother workflow.
  </div>
</div>
              {/* Header */}
